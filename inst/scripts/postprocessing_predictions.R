...
indir.US.repo = "~/git/US-covid19-agespecific-mortality-data"
...
source(file.path(indir.US.repo, "utils/summary.functions.R"))
source(file.path(indir.US.repo, "utils/sanity.check.function.R"))
source(file.path(indir.US.repo, "utils/make.plots.functions.R"))
...
outdir.pred = file.path(indir, 'predictions', last.day)
