...
if(grepl('211201a|211202a|211201c|211201d|220117a|220118a|220119a|220120a|220121a|220122a|220123a', stan_model)){
  cat("\n Using 2D splines \n")
...
if(grepl('220119a|220120a|220121a|220122a|220123a', stan_model)){
