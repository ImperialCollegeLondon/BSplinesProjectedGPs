...
transformed parameters {
  ...
  // vector[N] beta_raw = beta_raw_unscaled - mean(beta_raw_unscaled); 
  matrix[W,num_basis] beta = to_matrix(beta_raw_unscaled, W, num_basis); 
...
model {
  ...
  beta_raw_unscaled ~ sparse_iar(tau, Adj_sparse, D_sparse, egv, N, Adj_n);
