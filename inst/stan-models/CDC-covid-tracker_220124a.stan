...
model {
  ...
  vaccine_effect_intercept_diagonal ~ normal(0,5);
  vaccine_effect_slope_diagonal ~ normal(0,5);
  vaccine_effect_intercept_cross ~ normal(0,5);
  vaccine_effect_slope_cross ~ normal(0,5);
