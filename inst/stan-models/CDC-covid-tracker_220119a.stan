...
model {
  ...
  intercept_resurgence0 ~ normal(-0.3,1);
  slope_resurgence0 ~ normal(0,1);
  
  vaccine_effect_intercept_diagonal ~ normal(0,1);
  vaccine_effect_slope_diagonal ~ normal(0,1);
  vaccine_effect_intercept_cross ~ normal(0,1);
  vaccine_effect_slope_cross ~ normal(0,1);
