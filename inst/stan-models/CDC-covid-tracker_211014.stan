...
data{
  ...
  // vaccine effect
  //int<lower=1,upper=W> w_start_resurgence; // index of the week when Summer 2021 resurgences starts
  ...
  //int<lower=1> T; // number of weeks during the Summer 2021 resurgences (W-w_start_resurgence+1)
  ...
  //vector[T] week_indices_resurgence; // w_start_resurgence:W
}
