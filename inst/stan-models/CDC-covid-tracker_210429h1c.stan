functions {
            ...
            matrix z1)
  {
    ...
    real sqrtalpha_gp = sqrt(alpha_gp);
    
    K1 = cov_exp_quad(rows_idx, sqrtalpha_gp, rho_gp1) + diag_matrix(rep_vector(delta0, N_rows));
    K2 = cov_exp_quad(columns_index, sqrtalpha_gp, rho_gp2) + diag_matrix(rep_vector(delta0, N_columns));
