...
parameters {
  ...
  real vaccine_effect_intercept0;
  real vaccine_effect_intercept_diagonal[C];
  real vaccine_effect_slope0;
  real vaccine_effect_slope_diagonal[C];
  real<lower=0> sigma_vaccine_effect_slope;
  real<lower=0> sigma_vaccine_effect_intercept;
...
model {
  ...
  intercept_resurgence0 ~ normal(0,5);
  slope_resurgence0 ~ normal(0,5);
  
  vaccine_effect_intercept0 ~ normal(0, 2.5);
  vaccine_effect_slope0 ~ normal(0, 2.5);
  
  vaccine_effect_intercept_diagonal ~ normal(vaccine_effect_intercept0,sigma_vaccine_effect_intercept);
  vaccine_effect_slope_diagonal ~ normal(vaccine_effect_slope0,sigma_vaccine_effect_slope);
    
  sigma_intercept_resurgence ~ cauchy(0,1);
  sigma_r_pdeaths ~ cauchy(0,1);
  sigma_vaccine_effect_intercept ~ cauchy(0,1);
  sigma_vaccine_effect_slope ~ cauchy(0,1);

  for(c in 1:C){
    intercept_resurgence_re[c] ~ normal(0,sigma_intercept_resurgence);
  }
