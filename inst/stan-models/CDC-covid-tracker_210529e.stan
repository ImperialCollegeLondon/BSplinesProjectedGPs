functions {
            ...
            matrix z1)
  {
    ...
    K1 = cov_exp_quad(rows_idx, sqrt(alpha_gp1), rho_gp1) + diag_matrix(rep_vector(delta0, N_rows));
    K2 = cov_exp_quad(columns_index, sqrt(alpha_gp1), rho_gp2) + diag_matrix(rep_vector(delta0, N_columns));
