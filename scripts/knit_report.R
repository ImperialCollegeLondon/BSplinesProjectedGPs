...
indir = "/rds/general/user/mm3218/home/git/CDC-covid19-agespecific-mortality-data" # path to the repo
...
outdir.report = file.path(indir, 'reports', paste0('report_', run_tag, '.html'))
dir.report = file.path(indir, 'scripts', 'report.Rmd')
