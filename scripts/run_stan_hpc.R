...
plot_data(deathByAge_1, deathByAge_2, outdir = file.path(outdir, run_tag, 'figure', run_tag))
...
# Prepare stan data
cat("\n Prepare stan data \n")
stan_data_1 = prepare_stan_data(deathByAge_1, loc_name, ref_date)
stan_data_2 = prepare_stan_data(deathByAge_2, loc_name, ref_date)
...
if(grepl('210326|210329|210330|210406|210409|210412', stan_model)){
  cat("\n Using splines \n")
  stan_data = add_splines_stan_data(stan_data)
}
if(grepl('210406|210409|210412b', stan_model)){
...
if(grepl('210408b|210409|210412a|210412b', stan_model)){
  cat("\n Adding nodes index \n")
