...
# vaccination data
path.to.data = file.path(indir2, "data-vaccination", paste0("COVID-19_Vaccinations_in_the_United_States_Jurisdiction_220607.csv"))
...
# save
saveRDS(data, file.path(indir, "data", paste0("vaccination-prop-2022-06-07.rds")))
